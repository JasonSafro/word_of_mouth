...
<div id="wrapper" >
  ...
  <tr>
   ...
   $<?php echo $basic_plan_monthly_price;?> <h2><?php echo $basic_plan_monthly_name;?></h2>  
    ...
    <div class="clear"></div>
    <div class="green-btn">
        <?php if($this->session->userdata('claimRequesterUserId') == ''){ ?>
        <a href="#address10" id="address_pop" class="button6 green">SIGN UP</a>   
        <?php }else{?>
     <a href="#address11" id="address_pop" class="button6 green">SIGN UP</a>   
     <?php }?>
    <!--/*======================== popup start1=====================================/-->
     ...
     <!--------------------------------------step2--------------------------------------------------->
        ...
        ?>
           ...
           <label>Web Address</label>
            <input name="buss_web_addr" id="buss_web_addr"type="text"value="<?php echo set_value('buss_web_addr',$tmp_buss_web_address); ?>"/>
           ...
           <select name="userCategory" id="userCategory" class="items_custom">
                <?php 
                $categoryList= _getCategoryList();
                foreach($categoryList as $key=>$val){?>
               <option value="<?php echo $key;?>" <?php if($tmp_buss_category==$key){?> selected="selected" <?php }?>><?php echo $val;?></option>
                <?php }
                ?>           
            </select>
  ...
  {?>
   ...
   $<?php echo $prem_plan_monthly_price;?> <h2><?php echo $prem_plan_monthly_name;?></h2>  
    ...
    <div class="green-btn">
        ...
        <?php }else{?>
     <a href="#address13" id="address_pop" class="button6 green">SIGN UP</a>    
            <?php }?>
    <!--/*======================== popup2 start*=====================================/-->
<!----------------step1------------->
           <div>
        ...
        ?>
           ...
           <label>Web Address</label>
              <input name="p_buss_web_addr" id="p_buss_web_addr"type="text"value="<?php echo set_value('p_buss_web_addr',$tmp_buss_web_address);?>"/>
           ...
           <label>Business Category *</label>
            ...
            <select name="p_userCategory" id="p_userCategory" class="items_custom">
                ...
                $categoryList= _getCategoryList();
                foreach($categoryList as $key=>$val){?>
                    <option value="<?php echo $key;?>" <?php echo set_select('p_userCategory', $tmp_buss_category); ?>><?php echo $val;?></option>
                <?php }
                ?>           
            </select>
