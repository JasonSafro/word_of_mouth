...
<script type="text/javascript" charset="utf-8">
    ...
    <div id="page-wrap">
      ...
      <div id="section">
        ...
        <h4>Do you have any questions? Fill out the form below and we'll make sure to get back to you within 24 hours. </h4>
        <div class="clear"></div>
         <?php 
        ...
        <label>First Name *</label><input name="cnt_fname" type="text" value="<?php echo set_value('cnt_fname');?>"/><?php echo form_error('cnt_fname');?> 
         <label>Last Name *</label><input name="cnt_lname" type="text" value="<?php echo set_value('cnt_lname');?>"/><?php echo form_error('cnt_lname');?> 
          <label>Email Address *</label><input name="cnt_email" type="text" value="<?php echo set_value('cnt_email');?>"/><?php echo form_error('cnt_email');?> 
           <label>Reason *</label>
           <select name="cnt_reason"  style="width:549px;height:28px;">
           <option value="">---Select Option---</option>
           <?php  if(count($reasonList)!=0){foreach($reasonList as $key=>$val){?>
           		<option value="<?php echo $val['reason_id'];?>"><?php echo $val['reason_name'];?></option>
                <?php }} ?>
            </select>
             <?php echo form_error('cnt_reason');?>
