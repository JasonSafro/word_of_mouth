...
<!--                            <tr><td class="t-top1" COLSPAN="2" align="center"  style="margin-top: 4%;"><?php echo anchor('dashboard/manage_account', 'Edit', 'title="Edit" class="dash-inner dashorange" style="width:65px; text-align:center; margin-top:15px;"');?></td></tr>-->

                                </table>
                    </div>
                     <div class="dash-inner" style="margin-top:15px;">
                            <!--<input type="button" class="dashorange" value="submit"/>-->
                         <?php echo anchor('dashboard/manage_account', 'Edit', 'title="Edit" class="dashorange" ');?>
                      </div>
                </div>
