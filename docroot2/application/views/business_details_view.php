...
function saveratings(rating,busId)
	...
	<script type="text/javascript" src="<?php echo SITE_ROOT_FOR_USER?>assets/plugins/html5gallery/jquery.js"></script>
      ...
      <div id="main1">
        <section class="inside-title">
          <div class="inside-title-in">
            <div  id="main">
              <h1><?php echo $info['buss_name']; ?>  </h1>
              <div class="breadcrums"> <img src="<?php echo USER_SIDE_IMAGES;?>arrow.png" > <a href="<?php echo base_url()?>home">Home</a> | <?php echo $info['buss_name']; ?></div>
            </div>
          </div>
        </section>
      </div>
      <div id="section">
        <section id="main">
          <article class="section-deals">
            ...
            <?php if($is_favorite=="Yes"){?>
            <div class="fav" id="fav"><a><img src="<?php echo USER_SIDE_IMAGES;?>favou.png" > Favourite</a></div>
           <?php }else{?>
            <div class="addfav" id="addfav">
                <a  id="add_favor" href="#" onclick="add_into_fav('<?php echo $bus_id;?>','<?php echo $info['user_id'];?>');"><img src="<?php echo USER_SIDE_IMAGES;?>add-favou.png"  id="favorite"> <span id="txt">Add To Favourite</span></a>
            </div><?php  }?>
...
<?php /*?>                <div class="ratel1">
                ...
                <div class="over-add">
                    <div class="address"><br><br/>
                      ...
                      <?php $tempAddress=$info['buss_name'].','.$info['buss_address'].','.$info['buss_addr_addon'].','.$info['buss_city'];?>
                    <div class="directions">
                        <a href="https://maps.google.com/maps?saddr=&daddr=<?php echo $tempAddress;?>" target="_blanck">Get Directions Today</a>&nbsp;&nbsp; 
                        <?php if($info['buss_web_address']!=""){?>| &nbsp;&nbsp; <a href="<?php echo prep_url($info['buss_web_address']);?>" target="_blanck">Company Website</a>&nbsp;&nbsp;<?php }?> 
                         <?php if($info['buss_social_media_channel_1']!=""){?>| &nbsp;&nbsp;<a href="<?php echo prep_url($info['buss_social_media_channel_1']);?>" target="_blanck">Twitter Page</a>&nbsp;&nbsp;<?php }?>
                         <?php if($info['buss_social_media_channel_2']!=""){?>| &nbsp;&nbsp;<a href="<?php echo prep_url($info['buss_social_media_channel_2']);?>" target="_blanck">Facebook Page</a>&nbsp;&nbsp;<?php }?>
                         <?php if($info['buss_social_media_channel_3']!=""){?>| &nbsp;&nbsp;<a href="<?php echo prep_url($info['buss_social_media_channel_3']);?>" target="_blanck">Pinterest Page</a>&nbsp;&nbsp;<?php }?>
                         <?php if($info['buss_social_media_channel_4']!=""){?>| &nbsp;&nbsp;<a href="<?php echo prep_url($info['buss_social_media_channel_4']);?>" target="_blanck">Linked in Page</a><?php }?>
                    </div>
                  </div>
                </div>
              <div class="ntbr">
                <div class="full-des">
                  <h2><?php echo $info['buss_name']; ?><br/>
                  <span><?php echo $info['buss_tag_line'];?> </span></h2>
                  <p><?php echo $info['buss_description'];?></p>                  
                  <br><br><br><br>
                <!--<div class="book"><?php  if($info['buss_license_docs']!=""){ ?><img src="<?php echo USER_SIDE_IMAGES;?>down-load.png"> Business Documents<?php } ?></div>-->
                <!--<div class="write-review2"><a href="#"><img src="<?php echo USER_SIDE_IMAGES;?>down-l.png"> Download</a></div>-->
                <div class="write-review2" style="float:right; margin-right:0!important;"><a href="<?php echo base_url(); ?>home/reviews/<?php echo $businessId; ?>"><img src="<?php echo USER_SIDE_IMAGES;?>review.png"> Read Review</a></div>
                <div class="clear" style="height:20px"></div>
                <?php 
                $amIPremiumUser="No";
                if(!empty($u_info)){
                    if($u_info['user_plan']=='pm' || $u_info['user_plan']=='pa')
                    { 
                        $amIPremiumUser="Yes";
                    }
                }?>    
                
                <?php if($amIPremiumUser=='Yes' && $buss_comp_quot != ""){?>
                <div class="addfav"  style="width:84%;">
                  <a href="<?php echo base_url(); ?>home/competitive_quotes/<?php echo $businessId; ?>" id="address_pop" onclick="" style="width:auto; padding: 0 5px; float: right;">
                ...
                if($info['buss_license_docs']!=""){                
                    ...
                    /*foreach($businessDocs as $key=>$val){
                        echo '<p id="docsDivId_'.$key.'" style="width:16%;">'.                            
                            anchor('home/download_doc/'.$businessId.'/'.$val,img(array('src'=>base_url().'sitedata/images/download-ico.jpg')),array('target'=>"_blanck",'title'=>'Click here to download business document')).
                            ' Doc'.++$c.' '.'</p>';
                    } commented on 18-06-14 for doc name change*/
					function get_file_extension($file_name) {
						return substr(strrchr($file_name,'.'),1);
					}
											
                    foreach($businessDocs as $key=>$val){
							$var = get_file_extension($val);
							
						if($var=='PDF' || $var=='pdf')
						{
							//sitedata/images/download-ico.jpg
					    	echo '<p id="docsDivId_'.$key.'" style=" margin-top: 5px;position: relative;width: 100%;">'.                            
                            anchor('home/download_doc/'.$businessId.'/'.$val,img(array('src'=>base_url().'sitedata/images/pdf_icon-1.gif')),array('target'=>"_blanck",'title'=>'Click here to download business document')).
                            $val.'</p>';
                            //' Doc'.++$c.' '.'</p>';
						}
						else
						{
					    	echo '<p id="docsDivId_'.$key.'" style=" margin-top: 5px;position: relative;width: 100%;">'.                            
                            anchor('home/download_doc/'.$businessId.'/'.$val,img(array('src'=>base_url().'sitedata/images/blue-document-word-icon.png')),array('target'=>"_blanck",'title'=>'Click here to download business document')).
                            $val.'</p>';
                            //' Doc'.++$c.' '.'</p>';
						}
                    }
            ...
            <div class="ntb-main1">
              ...
              <div style="display:none;" class="html5gallery" data-skin="vertical" id="myVideoGallaryT" data-width="370" data-height="250">
                  ...
                  foreach($mediaImage as $img){
                      if($img!=""){?>
                        <a href="<?php echo base_url().'Media_Copy/'.$img;?>"><img src="<?php echo base_url().'Media_Copy/'.$img;?>" alt=""/></a>
                      <?php }?>
            <?php }?>
                  <?php 
                  $cnt=0;
                  foreach($busVideos as $vdo){
                      if($vdo!=""){?>
                        <a href="<?php echo base_url().'sitedata/business_videos/'.$vdo;?>" data-webm=""><img src="<?php echo base_url();?>sitedata/images/videoPlayer.jpg" alt=""/></a>
                      <?php }?>
            <?php }?>
            ...
            <?php if($amIPremiumUser=='Yes' && $mon_d_and_s != 0 && !empty($dealList)){?>
             <?php //if($amIPremiumUser=='Yes' && $mon_d_and_s != ""){?>
            <div class="deals-one">
              <h1>Deals</h1>
              <div class="deal-listing">
                <div id="canadaprovinces" class="glidecontentwrapperone">
                <?php $loopCount=1;
              //  echo "Check ";print_r($dealList); die;
                ?> 
            ...
            <?php }?>
            <div class="deals-two <?php echo ($amIPremiumUser=="Yes"?"deals-two5":"");?>">
              <h1>Reviews</h1>
                    ...
                    foreach($reviewList as $key=>$val){?>
                        ...
                        <div class="rating-main">
                            <div class="rating-view"><img src="<?php echo USER_SIDE_IMAGES;?>steve.jpg"  alt="steve">
                              <h2><?php echo anchor('home/review_details/'.$val['rvwId'],$val['rvwReviewerName'], 'title="Click here to read more"');?><span><?php echo $val['buss_city'];?></span></h2>
                            </div>
                            <div class="rate-date">
                           ...
                           <div class="rate-dis"><?php echo substr(nl2br($val['rvwDetails']),0,240).(strlen($val['rvwDetails'])>240?"...":""); ?></div>
                          </div>
                              <div class="clear"></div>
                         </li>
              ...
              <?php }//close empry if?>
                ...
                <div class="deals-p">
                  ...
                  <?php if($this->session->userdata('user_id')!=""){?>
                      <a href="#address15" id="address_pop" onclick="javascript: $('#back-top a').click();">WRITE A REVIEW</a>
                   <?php }else{?>
            ...
            <?php if($amIPremiumUser=='Yes' && $we_r_hir != "" && $we_r_hir != 0 && !empty($jobList)){?>
                ...
                <div id="canadaprovincesnewone" class="glidecontentwrapperone">
                  ...
                  <?php if(!empty($jobList)){?>   
                    ...
                    foreach($jobList as $key=>$val){
                            $today = date('Y-m-d');
                            //if($val['jobPostDate'] <= $today){
                            ?>
                  
                        <li>
                          <div class="text-deal"><?php echo anchor('home/job_view/'.$val['jobId'],$val['jobTitle']);?><br/>
                            <span>Posted: <?php echo $val['jobCreatedOn']; echo date('F j, Y', strtotime($val['jobCreatedOn']));?></span></div>
