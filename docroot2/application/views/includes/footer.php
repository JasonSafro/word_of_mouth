      ...
      <div class="footer-in">
        ...
        <div class="videos">
          ...
          <ul>
            ...
            <li>
              <div class="promo">
                  <a onclick="playFooterVideo('myFooterVideoModal_<?php echo $key;?>')" href="#" data-reveal-id="myFooterVideoModal_<?php echo $key;?>"><img src="<?php echo SITE_ROOT_FOR_USER.'sitedata/footer_videos_images/'.$val['fvImage'];?>" alt="video" title="<?php echo $val['fvTitle'];?>"></a>
        ...
        <div class="stay">
          ...
          <div class="bottom-logo"><img src="<?php echo USER_SIDE_IMAGES;?>logo-bottom.png" alt="logo" title="Word of Mouth Referral"></div>
          ...
          <div class="social1">
            <ul>
              <li><a href="https://twitter.com/WOMReferral" target="_blank"><img src="<?php echo USER_SIDE_IMAGES;?>twitt1.png" alt="twitter" title="twitter" /></a></li>
              <li><a href="https://www.facebook.com/WordOfMouthReferral" target="_blank"><img src="<?php echo USER_SIDE_IMAGES;?>facebook1.png" alt="facebook" title="facebook"/></a></li>
              <li><a href="http://www.pinterest.com/mouthreferral/" target="_blank"><img src="<?php echo USER_SIDE_IMAGES;?>printrest1.png" alt="printrest" title="printrest"/></a></li>
              <li><a href="http://www.linkedin.com/pub/Keri-seay/12/632/544" target="_blank"><img src="<?php echo USER_SIDE_IMAGES;?>linked-in1.png" alt="linked-in" title="linked-in" /></a></li>
              <li><a href="http://www.youtube.com/channel/UChsAXAMLDVAewzhrAdevQ-w" target="_blank"><img src="<?php echo USER_SIDE_IMAGES;?>YouTube.png" alt="youtube" title="youtube" height="25"/></a></li>
            </ul>
          </div>
        </div>
