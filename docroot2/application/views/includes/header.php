...
<meta property="og:url" content="http://wordofmouthreferral.com/" />
<meta property="og:image" content="http://wordofmouthreferral.com/sitedata/images/logo.png" />
<meta property="og:title" content="Word Of Mouth Referral" />
<meta property="og:description" content="Business Owners, Because you can't do today's job with yesterday's methods and be in business tomorrow..." />
<!-- <title>:: Word Of Mouth ::</title> -->
<?php $pg_name = $this->uri->segment(1); ?>

<title><?php  
if($pg_name == '')
{
	echo "Word of Mouth Referral | Find a Local Business, Ratings, Reviews, Deals";
}
else {
	$arr = _getMetadata($pg_name);
	echo $arr['title'];
}
?></title>
<meta name="description" content="<?php if($pg_name == '')
{
	echo "Word of Mouth Referral| Find a Local Businesses, See Ratings, Read Reviews, Download Deals, Apply for Jobs.";
}
else {
echo $arr['description'];
}?>" />

<meta name="keywords" content="<?php if($pg_name == '')
{
	echo "Reviews, Deals, Jobs, Word of Mouth, Referrals, Small Business, Business, Internet Marketing, Advertising";
}
else {
echo $arr['keywords']; 
}?>" />
...
<link rel="image_src" href="<?php echo USER_SIDE_IMAGES;?>logo.png"/>
<!--[if IE]>
  ...
  <div class="clearfix">
    <header>
      <div id="main" >
        ...
        <div class="logo"><?php echo anchor('home/', img(array('src' => USER_SIDE_IMAGES.'logo.png','border'=>"0", 'alt' => 'Word Of Mouth Referral', 'title' => 'Word Of Mouth Referral' ))); ?></div>
        <div class="fr">
          ...
          <div class="clear"></div>
          <div class="call-us">
            <div class="space"><img src="<?php echo USER_SIDE_IMAGES;?>spacer.gif" alt="spacer" width="5" title=" "></div>
