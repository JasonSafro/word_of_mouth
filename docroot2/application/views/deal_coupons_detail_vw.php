            ...
            <div class="deals-main">
                <ul id="listContainner">
                 ...
                 <li class="<?php echo ($cnt%3==0 && $cnt!=0?'last':"");?>">
                  ...
                  <div class="main-amc"><div class="amc"><a href="<?php echo site_url('home/business_details/'.$val['dealBusinessId']); ?>"><strong><?php echo $val['buss_name'];?></strong></a><br/><?php echo $val['buss_city'].','.$val['buss_addr_addon'];?><br/>
