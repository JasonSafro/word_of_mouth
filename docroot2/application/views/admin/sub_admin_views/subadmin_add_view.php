    ...
    <div id="right">
        ...
        <div class="box">
            ...
            <div class="table">
                    ...
                    $form_url1 = ADMIN_FOLDER_NAME.'/manage_subadmin/add_new/';                   
                    ...
                    <div class="fields">
                        ...
                        <div class="field">
                         ...
                         <div class="field">
                            ...
                            <div class="input">
                                <input name="adm_username" id="adm_username"  value="<?php echo set_value('adm_username'); ?>" type="text"  maxlength="30" size="50"/>
                        ...
                        <div class="field">
                            ...
                            <div class="input">
                                <input name="adm_email" id="adm_email"  value="<?php echo set_value('adm_email'); ?>" type="text" maxlength="60" size="50"/>
                        ...
                        <div class="field">
                            ...
                            <div class="input">
                                <input name="adm_password" id="adm_password"  value="<?php echo set_value('adm_password'); ?>" type="password" maxlength="60" size="50"/>
                        ...
                        <div class="field">
                            ...
                            <div class="input">
                                <input name="cadm_password" id="cadm_password" value="<?php echo set_value('cadm_password'); ?>"  type="password" maxlength="60" size="50"/>
                                <?php echo form_error('cadm_password');?>
                            </div>
                        </div>
                          ...
                          <div class="field">
                            ...
                            <div class="input">
                                <input name="adm_contactno" id="adm_contactno" value="<?php echo set_value('adm_contactno');?>" type="text" maxlength="10" size="50"/>
