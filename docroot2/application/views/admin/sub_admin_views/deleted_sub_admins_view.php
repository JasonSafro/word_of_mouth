...
<div id="content"> 
  ...
  <div id="right"> 
    ...
    <div class="box"> 
     <!-- box / title -->
      <div class="title">
        <h5>Manage Deleted Sub-Admin's</h5>
        <!--<div class="search">
      ...
      <!-- end box / title -->
            ...
            <?php
            $attr = array('name' => 'frmSubAdmin', 'id' => 'frmSubAdmin', 'autocomplete' => 'off', 'method' => 'post');
            $form_url = ADMIN_FOLDER_NAME.'/manage_subadmin/hard_delete_selected/'.$sort_by.'/'.$sort_type.'/'.($offset - 1);
           ...
           <div class="table">
                <table width="100%" id="myTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
                    <?php $newOffset= ($offset -1);?>
                        <thead>
                            <tr>
                               ...
                               <!-- <th width="11%" align="left" class="<?php echo ($sort_by=="adm_created_date" ? ($sort_type=="ASC" ? "rowASC" : "rowDESC") : "");?>">
                                ...
                                <th width="10%" align="left" class="<?php echo ($sort_by=="adm_status" ? ($sort_type=="ASC" ? "rowASC" : "rowDESC") : "");?>">
                                    <?php
                        ...
                        <?php foreach($subadminList as $key=>$val){?>
                        <tbody>
                               <tr>
                                    ...
                                    <td><?php $delete_url=ADMIN_FOLDER_NAME.'/manage_subadmin/delete_from_system/' .$val['adm_id'].'/'.$sort_by.'/'.$sort_type.'/'.$newOffset;?>
