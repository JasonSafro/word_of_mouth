     ...
     <!-- box / title -->
      ...
      <!-- end box / title -->
	   <?php
            ...
            $form_url = ADMIN_FOLDER_NAME.'/manage_promocodes/delete_selected/'.$sort_by.'/'.$sort_type.'/'.($offset - 1);
           ...
           <div class="table">
                <table width="100%" id="myTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
                    <?php $newOffset= ($offset -1);?>
                        ...
                        <tbody>
                               <tr>                                 
                                    <td class="selected"><input name="chkmsg[]" type="checkbox" value="<?php echo $val['pc_id'];?>" onclick="javascript:$('#chkall').removeAttr('checked');" class="chkmsg"/></td>
                                    <td><?php echo $i;?></td>
