    ...
    <div id="wrapper">
  	...
  	<!-- header -->
 		<div id="header">
			...
			<!-- user -->
			<ul id="user">
				<li class="first"><?php echo anchor(ADMIN_FOLDER_NAME.'/home/','Account' , 'title="Account"'); ?></li>
			...
			<div id="header-inner">
				...
				<li>
                                ...
                                <!-- Manage Sub-Admins-->
                                  <!--<li>
                                    <?php 
                                        ...
                                        echo anchor(ADMIN_FOLDER_NAME.'/manage_subadmin', 'Manage Sub-Admin',array('title'=>'Manage Sub-Admin','class'=>$cond)); 
                                     ?>   
                                       <ul>
                             ...
                             <!--   <li>
                                    <?php 
                                        ...
                                        echo anchor(ADMIN_FOLDER_NAME.'/', 'Manage Sales Manager and Reps',array('title'=>'Manage Sales Manager','class'=>$cond)); 
                                     ?> 
                                    <ul>
				...
				<li>
                                    ...
                                    <ul>
                                        ...
                                        <li><?php echo anchor(ADMIN_FOLDER_NAME.'/home','Email Contents' , 'title="Email Contents"'); ?></li>
                                    </ul>
                                </li>
