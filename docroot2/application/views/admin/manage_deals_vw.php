                    ...
                    <?php $newOffset= ($offset -1);?>
                        ...
                        <tbody>
                               <tr>   
                                   ...
                                   <td><a href="<?php echo SITE_ROOT_FOR_USER.'deals_and_coupons/view/'.$val['dealId'];?>"><img src="<?php echo USER_SIDE_IMAGES.'deal_images/thumbs/'.$val['dealImage'];?>" height="100" width="150"/></a></td>
