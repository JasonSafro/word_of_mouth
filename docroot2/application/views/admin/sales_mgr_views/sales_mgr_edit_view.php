...
<div id="content">
    ...
    <div id="right">
        ...
        <div class="box">
            ...
            <div class="table">
                    <?php 
                    $attr1 = array('name' => 'frmSalesMgr', 'id' => 'frmSalesMgr', 'autocomplete' => 'off', 'method' => 'post');
                    $form_url1 = ADMIN_FOLDER_NAME.'/manage_sales_mgr/add_new/'.$sort_by.'/'.$sort_type.'/'.$offset;
                    if($action=='Edit')
                    $form_url1 = ADMIN_FOLDER_NAME.'/manage_sales_mgr/edit/'.$sal_uid.'/'.$sort_by.'/'.$sort_type.'/'.$offset;
                 ...
                 <div class="form">
                    <div class="fields">
                        ...
                        <div class="buttons"> 
                            ...
                            <input type="button" class="ui-button custom-default-button" name="back" value="Back" onclick="javascript: location='<?php echo base_url().ADMIN_FOLDER_NAME."/manage_sales_mgr";?>'" /> 							
                            <!--div class="pagination">
                            <!--div class="results">
                                <span>
                            <?php echo anchor(ADMIN_FOLDER_NAME.'/manage_sales_mgr/', 'Back'); ?>
                                </span>
                            </div>
                        </div-->
                        </div>
