...
<div id="content"> 
  ...
  <div id="right"> 
    ...
    <div class="box"> 
     <!-- box / title -->
      <div class="title">
        <h5>Manage Registered Sales Managers</h5>
        <!--<div class="search">
      ...
      <!-- end box / title -->
            <?php
            $attr = array('name' => 'frmSalesMgr', 'id' => 'frmSalesMgr', 'autocomplete' => 'off', 'method' => 'post');
            $form_url = ADMIN_FOLDER_NAME.'/manage_sales_mgr/soft_delete_selected/'.$sort_by.'/'.$sort_type.'/'.($offset - 1);

            echo form_open($form_url, $attr);
            ?>
           <div class="table">
               <p><?php echo $total_sal_mgr_count;?> registered Sales-Managers - TOTAL</p>
                        ...
                        <thead>
                            ...
                            <tr>
                               ...
                               <!-- <th width="11%" align="left" class="<?php echo ($sort_by=="adm_created_date" ? ($sort_type=="ASC" ? "rowASC" : "rowDESC") : "");?>">
                                ...
                                <th width="8%" align="left" class="<?php echo ($sort_by=="adm_last_login_date" ? ($sort_type=="ASC" ? "rowASC" : "rowDESC") : "");?>">
                                    <?php
                              ...
                              <!--  <th width="11%" align="left" class="<?php echo ($sort_by=="adm_updated_date" ? ($sort_type=="ASC" ? "rowASC" : "rowDESC") : "");?>">
                                ...
                                <th width="9%" align="left" style="background: #E6EEEE;">Action</th>
                            </tr>
			</thead>
                        <?php foreach($sal_mgr_List as $key=>$val){?>
                        <tbody>
                               <tr>
                                    ...
                                    <td align="center"><?php echo $val['employNo'];?></td>
                                   ...
                                   <!-- <td><?php if($val['adm_updated_date']=='0000-00-00 00:00:00')echo "--";else echo $val['adm_updated_date'];?></td>-->
                                    ...
                                    <td>                                        
                                        <?php 
                                        $status_url=ADMIN_FOLDER_NAME.'/manage_sales_mgr/change_status/' .$sort_by.'/'.$sort_type.'/'.$newOffset;
                                        if($val['adm_status']=='A'){
                                        ...
                                        ?>
                                        <?php $sal_uid=$val['adm_id'];?>
                                        <?php $edit_url=ADMIN_FOLDER_NAME.'/manage_sales_mgr/edit/' .$val['adm_id'].'/'.$sort_by.'/'.$sort_type.'/'.$newOffset;?>
                                        <?php echo anchor($edit_url, img(array('src' => 'assets/images/edit.png', 'border' => '0', 'width' => '16', 'height' => '16', 'alt' => 'Edit record'))); ?> &nbsp;					
                                        <?php $delete_url=ADMIN_FOLDER_NAME.'/manage_sales_mgr/delete/' .$val['adm_id'].'/'.$sort_by.'/'.$sort_type.'/'.$newOffset;?>
