...
<script src="<?php echo base_url()?>assets/scripts/rating_function.js" type="text/javascript" charset="utf-8"></script>
              ...
              <div class="search-pro">
                <div class="bg-pro">
                 ...
                 ?>
                  ...
                  <input name="propertySearchText" id="propertySearchText" type="text"  class="textfield"  value="<?php echo ($previousSearchedProperty!=""?$previousSearchedProperty:"Search for your provider");?>" onBlur="if(this.value=='')this.value='Search for your provider';" onBlur="if(this.value=='')this.value='Search for your provider';" onFocus="if(this.value=='Search for your provider')this.value='';"/>
            ...
            <div class="deals-mainnew">
              ...
              <ul>                 
                ...
                <li <?php echo ($cnt!=0 && $cnt%3==0?'class="last"':'')?>>                     
                  <div class="deal-boxes deal-boxes5">
...
<?php /*?>                  <div class="rate">
            ...
            <div class="showing">
                <span>
                  <?php if($total_count>9){?>
                    ...
                    <?php }else {?>
                    Showing  <?php echo $current_count;//$remaining_list;?> of <?php echo $total_count;}    //$current_count;}?>
                </span>
            </div>
             <div class="clear"></div>
            ...
            <div class="see-mone"> 
                <?php if($total_count>9 && $remaining_list!=0){
                    ?>                
                <a href="<?php echo base_url()?>home/business_list/<?php echo $catId;?>/<?php echo $current_count+9;?>" class="button3 orange1">SEE <?php if($remaining_list>=9){?>9 <?php }else{ echo $remaining_list; }?> MORE PROVIDERS</a>       
                <?php }
                else
                {?>
                    <a href="javascript:history.back()" class="button3 orange1">GO BACK</a>       
                <?php }?>                              
            </div>             
          </article>
          <div class="clear"></div>
