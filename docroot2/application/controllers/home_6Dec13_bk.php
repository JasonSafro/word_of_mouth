...
class Home extends CI_Controller {
     ...
     function search_by_zipcode($limit=9)
    {
        ...
        {   
            ...
            //echo $this->session->userdata('srhBussZipCode'); die;
        }
    ...
    public function business_details($bus_id=NULL)
    {
    ...
    function __getBusinessDetails($bus_id){
        ...
        //get reviews
        $whereReviews="WHERE rvwStatus='Active'";
    ...
    function add_business_review($bus_id){    
        ...
        $this->form_validation->set_rules('rvwEmail', 'Email address', 'xss_clean|trim|required|callback_rvwEmailAddressChk');
   ...
   function rvwDetailsChk($str){
    ...
    function apply_today($jobId=NULL)
    {
        ...
        {  
            ...
            $this->form_validation->set_rules('jAppApplicantCity', 'City', 'xss_clean|trim|required|max_length[40]');
            $this->form_validation->set_rules('jAppApplicantState', 'State', 'xss_clean|trim|required|max_length[40]');
            ...
            $this->form_validation->set_rules('jAppApplicantEmail', 'Email', 'xss_clean|trim|required|max_length[60]');
