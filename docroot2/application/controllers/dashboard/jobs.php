...
class Jobs extends CI_Controller {
    ...
    function new_job()
    {
        ...
        $data['error_occured'] = "n";
           ...
           //echo "Name:".$this->input->post('jobTitle').'<br/>';
           $emailBody=str_replace ("[[JOB_NAME]]", $this->input->post('jobTitle'), $emilTemplet);
           $emailBody=str_replace ("[[BUSINESS_NAME]]", $bussinfo[0]['buss_name'], $emailBody);
    ...
    function delete_job($jobId){
        ...
        if($jobId!='' && _isRecordExist('tbl_jobs',$where))
        {
            ...
            $this->session->set_flashdata('success',"Sorry! you can not delete this job.");            
        }        
        redirect('dashboard/jobs');
    }
