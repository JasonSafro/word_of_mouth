...
class We_are_hiring extends CI_Controller {
    ...
    function search($limit=9){
        ...
        if($propertySearchText!="" && $propertySearchText!="Search for your provider"){
            $whereSearchBusiness="(buss_name LIKE '%".$propertySearchText."%' OR buss_address LIKE '%".$propertySearchText."%' OR buss_city LIKE '%".$propertySearchText."%' OR catName LIKE '".$propertySearchText."' OR catDescription LIKE '%".$propertySearchText."%' OR buss_description LIKE '%".$propertySearchText."%')";
        }
   ...
   function search_by_zipcode($limit=9)
    ...
    {   
        ...
        if($propertySearchText!=""){
            $whereSearchBusiness="WHERE (buss_name LIKE '%".$propertySearchText."%' OR buss_address LIKE '%".$propertySearchText."%' OR buss_city LIKE '%".$propertySearchText."%' OR catName LIKE '".$propertySearchText."' OR catDescription LIKE '%".$propertySearchText."%' OR buss_description LIKE '%".$propertySearchText."%' ) AND j.jobStatus !='Deleted' GROUP BY j.jobBusinessId";
        }else{
            $whereSearchBusiness="j.jobStatus !='Deleted' GROUP BY j.jobBusinessId";
        }
