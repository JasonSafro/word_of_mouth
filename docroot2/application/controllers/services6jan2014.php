...
class Services extends CI_Controller {
    ...
    function submitForm_buss_basic($data)
    {
        ...
        $this->form_validation->set_rules('buss_name', 'Name', 'xss_clean|trim|required|alpha_numeric|max_length[32]');
    ...
    {
        $this->form_validation->set_rules('p_buss_name', 'Name', 'xss_clean|trim|required|alpha_numeric|min_length[4]|max_length[32]');
