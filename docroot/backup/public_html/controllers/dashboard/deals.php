...
class Deals extends CI_Controller {
    ...
    function index(){
        ...
        $data=array('user_id'=>$userId,'newImageError'=>'','editImageError'=>'','newDealDocumentError'=>'','editDealDocumentError'=>'');
        /*$table = 'tbl_deals';        
        $where= array('dealUserId' => $userId);
        $data['dealList'] = $this->mdgeneraldml->select('*', $table, $where);*/
        $where="WHERE d.dealUserId=$userId";
        $data['dealList'] = $this->WGModel->getDealList($where);
    ...
    function getDeal($dealId)
    {
        ...
        { 
            ...
            $dealList = $this->WGModel->getDealList($where);
            $dealList = $dealList[0];
