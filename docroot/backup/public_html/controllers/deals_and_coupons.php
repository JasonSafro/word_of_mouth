...
class Deals_and_coupons extends CI_Controller {
    ...
    public function index($limit=30){
        ...
        if($this->session->userdata('user_id')!="")
        {
            ...
            if($zipCodesString!="")
                $where="WHERE b.buss_zip_code IN($zipCodesString) AND b.bussHasDeal='Yes'";
        }  
    ...
    {       
        ...
        if($propertySearchText!="" && $propertySearchText!="Search for your provider"){            
                $whereSearchBusiness="(dealOverview LIKE '%".$propertySearchText."%' OR buss_name LIKE '%".$propertySearchText."%' OR buss_address LIKE '%".$propertySearchText."%' OR buss_city LIKE '%".$propertySearchText."%')";
        }
    ...
    function search($limit=30){
        ...
        if($propertySearchText!="" && $propertySearchText!="Search for your provider"){
            ...
            if($bussIdsString!="")
                $whereSearchBusiness="dealOverview LIKE '%".$propertySearchText."%' OR buss_name LIKE '%".$propertySearchText."%' OR buss_address LIKE '%".$propertySearchText."%' OR buss_city LIKE '%".$propertySearchText."%' OR buss_id in($bussIdsString)";
            else
                $whereSearchBusiness="dealOverview LIKE '%".$propertySearchText."%' OR buss_name LIKE '%".$propertySearchText."%' OR buss_address LIKE '%".$propertySearchText."%' OR buss_city LIKE '%".$propertySearchText."%'";
        }
    ...
    {   
        ...
        if($propertySearchText!=""){
            if($bussIdsString!="")
                $whereSearchBusiness="WHERE dealOverview LIKE '%".$propertySearchText."%' OR buss_name LIKE '%".$propertySearchText."%' OR buss_address LIKE '%".$propertySearchText."%' OR buss_city LIKE '%".$propertySearchText."%' OR buss_id in($bussIdsString)";
            else
                $whereSearchBusiness="WHERE dealOverview LIKE '%".$propertySearchText."%' OR buss_name LIKE '%".$propertySearchText."%' OR buss_address LIKE '%".$propertySearchText."%' OR buss_city LIKE '%".$propertySearchText."%'";
        }else{
            $whereSearchBusiness="";
        }
