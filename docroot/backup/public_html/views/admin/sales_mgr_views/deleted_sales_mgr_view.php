...
<div id="content"> 
  ...
  <div id="right"> 
    ...
    <div class="box"> 
     <!-- box / title -->
      <div class="title">
        <h5>Manage Deleted Sales Manager's</h5>
       <!-- <div class="search">
      ...
      <!-- end box / title -->
            ...
            $form_url = ADMIN_FOLDER_NAME.'/manage_sales_mgr/hard_delete_selected/'.$sort_by.'/'.$sort_type.'/'.($offset - 1);
           ...
           <div class="table">
                <table width="100%" id="myTable" class="tablesorter" border="0" cellpadding="0" cellspacing="1">
                    <?php $newOffset= ($offset -1);?>
                        ...
                        <?php foreach($salesmgrList as $key=>$val){?>
                        <tbody>
                               <tr>
                                    ...
                                    <td><?php $delete_url=ADMIN_FOLDER_NAME.'/manage_sales_mgr/delete_from_system/' .$val['adm_id'].'/'.$sort_by.'/'.$sort_type.'/'.$newOffset;?>
