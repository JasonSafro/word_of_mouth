...
<div id="myModalFooterVideo2" class="reveal-modal">
  <video poster="http://media.w3.org/2010/05/sintel/poster.png" preload="none" controls="" id="video" tabindex="0" width="520" height="380">
    <source type="video/mp4" src="<?php echo base_url()?>assets/video/video2.mp4" id="mp4"></source>
    <source type="video/webm" src="<?php echo base_url()?>assets/video/video2.webm" id="webm"></source>
    <source type="video/ogg" src="<?php echo base_url()?>assets/video/video2.ogv" id="ogv"></source>
    <p>Your user agent does not support the HTML5 Video element.</p>
  </video>
  <a class="close-reveal-modal">&#215;</a> 
</div>
...
<a href="#"><span class="top-padd"><img src="<?php echo USER_SIDE_IMAGES;?>download.png"> </span>&nbsp;DOWNLOAD</a></div>
     ...
     <!--------------------------------------credit card------------------------------------------------- -->             
          ...
          <?php 
           ...
           <div class="link-orange">  <a href="<?php echo site_url('services/terms_and_condition');?>" target="_blanck">READ  FULL TERMS & CONDITIONS</a> </div>     
...
<a href="#"><span class="top-padd"><img src="<?php echo USER_SIDE_IMAGES;?>download.png"> </span>&nbsp;(Accolades) Download</a></div>
     ...
     <!--------------------------------------credit card------------------------------------------------- -->             
          ...
          <?php 
           ...
           <div class="link-orange">  <a href="<?php echo base_url()?>services/terms_and_condition" target="_blank">READ  FULL TERMS & CONDITIONS</a> </div>     
      ...
      <div class="footer-in"><div class="links">
        ...
        <div class="videos">
          ...
          <ul>
            ...
            <li>
              <div class="promo"><a href="#" data-reveal-id="myModalFooterVideo2"><img src="<?php echo USER_SIDE_IMAGES;?>player2.png" alt="video"></a>
                <p><span>Aenean  Pellentesque</span><br/>
                  Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Praesent commodo cursus magna.</p>
              </div>
              <div class="dating">
