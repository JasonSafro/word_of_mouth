                    ...
                    foreach($reviewList as $key=>$val){?>
                        ...
                        <div class="rating-main">
                            ...
                            <div class="rate-date">
                              ...
                              <ul class="rating <?php echo $ratingClasses[$currentRating];?>">                         
                              <li class="one"><a href="#" onclick="saveratings(1,<?php echo $val['rvwBusinessId'];?>)" title="1 Star">1</a></li>
                              <li class="two"><a href="#" onclick="saveratings(2,<?php echo $val['rvwBusinessId'];?>)" title="2 Stars">2</a></li>
                              <li class="three"><a href="#" onclick="saveratings(3,<?php echo $val['rvwBusinessId'];?>)" title="3 Stars">3</a></li>
                              <li class="four"><a href="#" onclick="saveratings(4,<?php echo $val['rvwBusinessId'];?>)" title="4 Stars">4</a></li>
                              <li class="five"><a href="#" onclick="saveratings(5,<?php echo $val['rvwBusinessId'];?>)" title="5 Stars">5</a></li>                      
                            </ul>  
                            </div>
