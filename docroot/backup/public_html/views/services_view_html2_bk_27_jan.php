...
<?php echo js_asset("jquery.selectbox-0.5.js");  ?>
  ...
  <script type="text/javascript" charset="utf-8">
        ...
        function print_state2(state_id, countryCode){ 
             $.ajax({
                    type: "GET",                                        
                    //url: '<?php echo base_url() ?>services/getState/'+countryCode,
                    url: '<?php echo base_url() ?>services/getStateList/'+countryCode,
	...
	$(document).ready(function() {
		$('.items').selectbox();
		 ...
		 //When Page Loads- Get State by country(Basic)
            ...
            if(e!=''){
            var strUser = e.options[e.selectedIndex].value;                          
            print_state2('p_userState',strUser);}
            else{
		 ...
		 //When Country Changes, Change State 
                    ...
                    //Premium Form (ADDED)
                     $('#p_userCountry_input').blur(function(){
                       setTimeout(function(){
                           var e = document.getElementById("p_userCountry");
                           var strUser = e.options[e.selectedIndex].value;
                           print_state('p_userState',strUser);
                    ...
                    $("#acc_type_input").blur(function() {$('#promocode').val("");$("#pro_code_err").html("");
                             setTimeout(function(){
                ...
                $("#b_acc_type_input").blur(function() {$('#b_promocode').val("");$("#b_pro_code_err").html("");
                    setTimeout(function(){
                ...
                //Premium Plan Page 1 for price
                $("#p_acc_type_input").blur(function() {$('#p_promocode').val("");$("#p_pro_code_err").html("");
                    setTimeout(function(){
                        var e = document.getElementById("p_acc_type");
                        var acc_type = e.options[e.selectedIndex].value;  
                        // alert(acc_type);
                        if(acc_type=="pm")
                            $('#p_price').html('<?php echo $prem_plan_monthly_price; ?>');
                        else
                            $('#p_price').html('<?php echo $prem_plan_annual_price; ?>');
                    },500)         
                });


                //Premium Plan Page 2 for price
                $("#p_acc_type1_input").blur(function() {$('#p_promocode1').val("");$("#p_pro_code_err1").html("");
                    setTimeout(function(){
      ...
      <div id="main" >
        ...
        <div class="logo"><?php echo anchor('user/home/', img(array('src' => USER_SIDE_IMAGES.'logo.png','border'=>"0", 'alt' => 'logo'))); ?></div>
          ...
          <div class="call-us">
            ...
            <span>Call Us Today: 1-800-363-5791</span></div>
        </div>
        <div class="call-us1">
          <div class="space"><img src="<?php echo USER_SIDE_IMAGES;?>spacer.gif" alt="spacer" width="5"></div>
          Call Us Today: 1-800-363-5791</div>
        <div class="clear"></div>
      </div>
        </div>
        <nav>
   ...
   $<?php echo $basic_plan_monthly_price;?> <h2><?php echo $basic_plan_monthly_name;?></h2>  
    ...
    <!--/*======================== popup start1=====================================/-->
      ...
      <input  style="display:none;" name="submitbtn12" id="submitbtn12" value="PROCEED TO STEP 2"  type="submit"/>
           ...
           <?php if($error!=''){?>
           <br/><h2>Please provide the correct credit card details and Try Again..</h2>
           <?php }?>
              <div class="form2">
     <!--------------------------------------step2--------------------------------------------------->
              <?php
        $attributes = array('name' => 'frmSignup_buss_basic', 'id' => 'frmSignup_buss_basic1', 'method' => 'post');
        echo form_open_multipart('services/index/basic/2#address11', $attributes);
        ?>
           <div class="pop-left ">
           <div class="pop-left-first">
           ...
           <label>Contact Name</label>
            <input name="buss_cont_name" id="buss_cont_name"type="text"value="<?php echo set_value('buss_cont_name'); ?>">
           ...
           <label>Address * </label>
            <input name="buss_addr" id="buss_addr" type="text"value="<?php echo set_value('buss_addr'); ?>">
             <?php echo form_error('buss_addr');?>
           </div>
           <div class="pop-left-second">
            <h4>&nbsp; </h4>
           <label>Address add on</label>
            <input name="buss_addr_addon" id="buss_addr_addon" type="text"value="<?php echo set_value('buss_addr_addon'); ?>">
           ...
           <label>City * </label>
            <input name="buss_city" id="buss_city"type="text"value="<?php echo set_value('buss_city'); ?>">
            <?php echo form_error('buss_city');?>
           </div>
           <div class="pop-left-second">
     
           <label>Zip code *</label>
            <input name="buss_zipcode" id="buss_zipcode"type="text"value="<?php echo set_value('buss_zipcode'); ?>">
           ...
           <label>Phone *</label>
            <input name="buss_phone" id="buss_phone"type="text"value="<?php echo set_value('buss_phone'); ?>" >
              <?php echo form_error('buss_phone');?>
           </div>
           <div class="pop-left-second">
      
           <label>Fax</label>
            <input name="buss_fax" id="buss_fax"type="text" value="<?php echo set_value('buss_fax'); ?>">
           ...
           <label>Web Address</label>
            <input name="buss_web_addr" id="buss_web_addr"type="text"value="<?php echo set_value('buss_web_addr'); ?>">
            <?php echo form_error('buss_web_addr');?>
           </div>
           <div class="pop-left-second">
      
           <label>Contact Email Address *</label>
            <input name="buss_email_addr" id="buss_email_addr" type="text"value="<?php echo set_value('buss_email_addr'); ?>">
           ...
           <label>Business Category *  (2 Max)</label>
            ...
            <?php 
           //$xm='id="userCategory" class="items"';
           //echo form_dropdown('userCategory', _getCategoryList(),set_value('userCategory'),$xm);
           ?>
           <div style=" float:left; width:100%; background: #fff; border: 1px solid #A1A1A1; border-radius:9px; margin:0 0 15px 0;">
               <select name="userCategory[]" id="userCategory"  multiple style="background:none; border:none; width:98%; padding: 0 2%; margin:2% 0">
                ...
                foreach($categoryList as $key=>$val){?>
                    <option value="<?php echo $key;?>" <?php echo set_select('userCategory[]',$key); ?>><?php echo $val;?></option>
                <?php }?>
                    <option value="other" <?php echo set_select('userCategory[]', 'other'); ?>>Other category</option>
            </select></div>
           ...
           <label>Business License Number</label>
            <input name="buss_lice_num" id="buss_lice_num" type="text"value="<?php echo set_value('buss_lice_num'); ?>">
             <?php echo form_error('buss_lice_num');?>
           </div>
           
           <div class="clear"></div>
           <div class="pop-left-first" id="otherCatDiv" style="display:none">
...
<a href="<?php echo site_url('services/download');?>" target="_blanck"><span class="top-padd"><img src="<?php echo USER_SIDE_IMAGES;?>download.png"> </span>&nbsp;DOWNLOAD</a></div>
           </div>
           ...
           <div class="pop-left-second">
               ...
               <div class="write-review2">
                   <a onclick="javascript: $('#upload_logo').click();"><img src="<?php echo USER_SIDE_IMAGES; ?>upload.png">&nbsp; UPLOAD LOGO</a>
                   <input  style="display:none;" name="upload_logo" id="upload_logo" type="file"/>                  
           ...
           <div class="clear"></div>
            <div class="pop-left-first">
               ...
               <div class="write-review2">
                   <a onclick="javascript: $('#upload_photos').click();"><img src="<?php echo USER_SIDE_IMAGES; ?>upload.png">&nbsp; UPLOAD PHOTOS</a>
                   <input  style="display:none;" name="upload_photos[]" id="upload_photos" accept="image/*" multiple type="file"/>
                   ...
                   <div class="centeralign"> <label> <span><?php if($service_limits[3]['service_basic_limit']=='0'){?>Unlimited <?php }else if($service_limits[3]['service_basic_limit']!=''){echo $service_limits[3]['service_basic_limit']." Max";}?></span></label></div>
               
               </div>
           </div>
           
           <div class="pop-left-second">
                <br/><br/><h4><img src="<?php echo USER_SIDE_IMAGES; ?>media.png"> &nbsp;Upload Business License Certification </h4> 
               <div class="write-review2">
                   <a onclick="javascript: $('#license_docs').click();"><img src="<?php echo USER_SIDE_IMAGES; ?>upload.png">&nbsp; UPLOAD DOCS</a>
                   <input  style="display:none;" name="license_docs[]" id="license_docs" multiple type="file"/>                  
           ...
           <br>
            ...
            <div class="pop-left-first-two"><input name="buss_sco_one" id="buss_sco_one" type="text"value="<?php echo set_value('buss_sco_one'); ?>"></div>
            <div class="clear"></div>
             <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h2.png"></div>
            <div class="pop-left-first-two"><input name="buss_sco_two" id="buss_sco_two" type="text"value="<?php echo set_value('buss_sco_two'); ?>"></div>
            <div class="clear"></div>
           </div>
           <div class="pop-left-second">
            <h4>&nbsp; </h4>
           <label>&nbsp;</label><br>
            ...
            <div class="pop-left-first-two"><input name="buss_sco_three" id="buss_sco_three" type="text"value="<?php echo set_value('buss_sco_three'); ?>"></div>
             <div class="clear"></div>
              <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h4.png"></div>
            <div class="pop-left-first-two"><input name="buss_sco_four" id="buss_sco_four" type="text"value="<?php echo set_value('buss_sco_four'); ?>"></div>
             <div class="clear"></div>
           </div>
           <div class="clear"></div>      
           <div class="full2">
     ...
     <!--------------------------------------credit card------------------------------------------------- -->             
          ...
          <label>Email </label>
           ...
           <label>Country *</label>
           <?php 
           $xm='id="c_userCountry" class="items"';
           echo form_dropdown('c_Items', _getCountryList(),set_value('c_Items','USA'),$xm);
           ?>
            <!--<select name="c_Items" id="c_userCountry" class="items">
                <?php 
                $countryList= _getCountryList();
                foreach($countryList as $key=>$val){?>
           ...
           <label>State *</label>
            <input name="c_state" id="c_state"type="text" value="<?php echo set_value('c_state');?>">
    ...
    <?php if($val['service_basic_status']=='A'){?>
		...
		$("#b_promocode").keyup(function(){		
			var b_promo_code = $("#b_promocode").val();
                        var b_plan_sub_type=$("#b_acc_type_input").val();                                              
...
<!----------------step1----------- -->
        ...
        //echo form_open('services/submitForm_basic', $attributes);
        echo form_open('services/index/prem/1#address12', $attributes);
        ?>
           <div class="pop-left fullwdth">
           <div class="pop-left-first">
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>create.png"> &nbsp; Create your username</h4>
        ...
        <input name="p_addr_addon" id="p_addr_addon"type="text" value="<?php echo set_value('p_addr_addon',$user_info_array['user_address_addon']);?>">
          ...
          <?php echo form_error('p_city');?>
           ...
           <label>Country *</label>
            <select name="p_Items" id="p_userCountry" class="items">
               <?php
                                        $countryList = _getCountryList();    
                                         if ($user_info_array['user_country'])
                                            {
          ...
          <div id="p_stateHolder">
            <?php 
                           // $st='id="userState" class="items"';//stateHolder
                            //echo form_dropdown('userState', _getStateList(),set_value('userState'),$st);                            
                        ?>   
               <select name="p_userState" id="p_userState" class="items">
            <option>Choose your state</option>
            </select>
        ...
        echo form_open_multipart('services/index/prem/2#address13', $attributes);
        ?>
           <div class="pop-left">
           <div class="pop-left-first">
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>create.png"> &nbsp; Business Name</h4>
           <label>Name *<span>(alphanumeric, no more than 32 characters)</span></label>
            <input name="p_buss_name" id="p_buss_name"type="text" value="<?php echo set_value('p_buss_name'); ?>">
            <?php echo form_error('p_buss_name');?>
           </div>
           <div class="pop-left-second">
            <h4> &nbsp;</h4>
           <label>Contact Name</label>
            <input name="p_buss_cont_name" id="p_buss_cont_name"type="text"value="<?php echo set_value('p_buss_cont_name'); ?>">
           ...
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>home2.png"> &nbsp; Business Details</h4>
           <label>Address * </label>
            <input name="p_buss_addr" id="p_buss_addr" type="text"value="<?php echo set_value('p_buss_addr'); ?>">
             <?php echo form_error('p_buss_addr');?>
           </div>
           <div class="pop-left-second">
            <h4>&nbsp; </h4>
           <label>Address add on</label>
           <input name="p_buss_addr_addon" id="p_buss_addr_addon" type="text"value="<?php echo set_value('p_buss_addr_addon'); ?>">
           ...
           <label>City * </label>
             <input name="p_buss_city" id="p_buss_city"type="text"value="<?php echo set_value('p_buss_city'); ?>">
            <?php echo form_error('p_buss_city');?>
           </div>
           <div class="pop-left-second">
     
           <label>Zip code *</label>
            <input name="p_buss_zipcode" id="p_buss_zipcode"type="text"value="<?php echo set_value('p_buss_zipcode'); ?>">
           ...
           <label>Phone *</label>
            <input name="p_buss_phone" id="p_buss_phone"type="text"value="<?php echo set_value('p_buss_phone'); ?>" >
              <?php echo form_error('p_buss_phone');?>
           </div>
           <div class="pop-left-second">
      
           <label>Fax</label>
            <input name="p_buss_fax" id="p_buss_fax"type="text"value="<?php echo set_value('p_buss_fax'); ?>" >
           ...
           <label>Web Address</label>
              <input name="p_buss_web_addr" id="p_buss_web_addr"type="text"value="<?php echo set_value('p_buss_web_addr'); ?>">
            <?php echo form_error('p_buss_web_addr');?>
           </div>
           <div class="pop-left-second">
      
           <label>Contact Email Address *</label>
             <input name="p_buss_email_addr" id="p_buss_email_addr" type="text"value="<?php echo set_value('p_buss_email_addr'); ?>">
          ...
          <!-- <div style="  width:100%; background: #fff; border: 1px solid #A1A1A1; border-radius:9px; margin:0 0 15px 0;"><select name="p_userCategory" id="p_userCategory"  multiple style="background:none; border:none; width:98%; padding: 0 2%; margin:2% 0">-->
            <?php 
           //$xm='id="p_userCategory" class="items"';
           //echo form_dropdown('p_userCategory', _getCategoryList(),set_value('p_userCategory'),$xm);
           ?>
           <div style=" float:left; width:100%; background: #fff; border: 1px solid #A1A1A1; border-radius:9px; margin:0 0 15px 0;">
               <select name="p_userCategory[]" id="p_userCategory"  multiple style="background:none; border:none; width:98%; padding: 0 2%; margin:2% 0">
                
            <!--<select name="p_userCategory" id="p_userCategory" class="items"> -->
                <?php 
                $categoryList= _getCategoryList();
                foreach($categoryList as $key=>$val){?>
                    <option value="<?php echo $key;?>" <?php echo set_select('p_userCategory[]', $key); ?>><?php echo $val;?></option>
                <?php }
                ?> 
                 <option value="other" <?php echo set_select('p_userCategory[]', 'other'); ?>>Other category</option>
            </select>
           </div>
           <label>Tip: use Ctrl key to select multiple categories.</label>
           ...
           <label>Business License Number</label>
             <input name="p_buss_lice_num" id="p_buss_lice_num" type="text" value="<?php echo set_value('p_buss_lice_num'); ?>">
             <?php echo form_error('p_buss_lice_num');?>
           </div>
           
           <div class="clear"></div>
           <div class="pop-left-first" id="p_otherCatDiv" style="display:none">
           <label>Other Category</label>
              <input name="p_otherCategory" id="p_otherCategory" type="text" value="<?php echo set_value('p_otherCategory'); ?>"/>
            <?php echo form_error('p_otherCategory');?>
           </div>
  ...
  <h4><img src="<?php echo USER_SIDE_IMAGES;?>lic.png"> &nbsp;Business License Certification </h4> 
            <div class="write-review2">
<a href="<?php echo site_url('services/download');?>" target="_blanck"><span class="top-padd"><img src="<?php echo USER_SIDE_IMAGES;?>download.png"> </span>&nbsp;(Accolades) Download</a></div>
           </div>
           ...
           <div class="pop-left-second">
               <h4><img src="<?php echo USER_SIDE_IMAGES; ?>media.png"> &nbsp;Upload Your Logo </h4> 
               <div class="write-review2">
                   <a onclick="javascript: $('#p_upload_logo').click();"><img src="<?php echo USER_SIDE_IMAGES; ?>upload.png">&nbsp; UPLOAD LOGO</a>
                   <input  style="display:none;" name="p_upload_logo" id="p_upload_logo" type="file"/>                  
           ...
           <div class="clear"></div>
              ...
              <br/> <h4><img src="<?php echo USER_SIDE_IMAGES; ?>media.png"> &nbsp;Upload Your Media copy  </h4> 
               <div class="write-review2">
                 <a onclick="javascript: $('#p_upload_photos').click();"><img src="<?php echo USER_SIDE_IMAGES; ?>upload.png">&nbsp; UPLOAD PHOTOS</a>
                  <input  style="display:none;" name="p_upload_photos[]" id="p_upload_photos" accept="image/*" multiple type="file"/>
           ...
           <div class="pop-left-second">
                <br/><h4><img src="<?php echo USER_SIDE_IMAGES; ?>media.png"> &nbsp;Upload Business License Certification </h4> 
               <div class="write-review2">
                   <a onclick="javascript: $('#p_license_docs').click();"><img src="<?php echo USER_SIDE_IMAGES; ?>upload.png">&nbsp; UPLOAD DOCS</a>
                   <input  style="display:none;" name="p_license_docs[]" id="p_license_docs" multiple type="file"/>                  
          ...
          <label> <input name="comp_quot" type="checkbox" value="1"> &nbsp;Click to receive competitive quotes</label>
           <input name="addition_email" type="text" value="(Enter Your Email Address)"  onFocus="if(this.value=='Enter Your Email Address')this.value=''" onBlur="if(this.value=='')this.value='Enter Your Email Address'">
           </div>
           <div class="pop-left-second">
            <h4> &nbsp;</h4>
          <label> <input name="mon_d_and_s" type="checkbox" value="1"> &nbsp;Click to submit monthly deals & specials</label>
           <label> <input name="we_r_hir" type="checkbox" value="1"> &nbsp;We’re Hiring</label>
           </div>
           <div class="clear"></div>
           </div>
             <div class="full2">
           ...
           <br>
             <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h1.png"></div>
            <div class="pop-left-first-two"><input name="p_buss_sco_one" id="p_buss_sco_one" type="text"value="<?php echo set_value('p_buss_sco_one'); ?>"></div>
            <div class="clear"></div>
             <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h2.png"></div>
            <div class="pop-left-first-two"><input name="p_buss_sco_two" id="p_buss_sco_two" type="text"value="<?php echo set_value('p_buss_sco_two'); ?>"></div>
            <div class="clear"></div>
           </div>
           <div class="pop-left-second">
            <h4>&nbsp; </h4>
           <label>&nbsp;</label><br>
            <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h3.png"></div>
            <div class="pop-left-first-two"><input name="p_buss_sco_three" id="p_buss_sco_three" type="text"value="<?php echo set_value('p_buss_sco_three'); ?>"></div>
             <div class="clear"></div>
              <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h4.png"></div>
            <div class="pop-left-first-two"><input name="p_buss_sco_four" id="p_buss_sco_four" type="text"value="<?php echo set_value('p_buss_sco_four'); ?>"></div>
             <div class="clear"></div>
           </div>
           <div class="clear"></div>
           <div class="full2">
     ...
     <!--------------------------------------credit card------------------------------------------------- -->             
          ...
          <label>Email </label>
           ...
           <label>Country *</label>
           <?php 
           $xm='id="p_c_userCountry" class="items"';
           echo form_dropdown('p_c_Items', _getCountryList(),set_value('p_c_Items','USA'),$xm);
           ?>
            <!--<select name="p_c_Items" id="p_c_userCountry" class="items">
                <?php 
                $countryList= _getCountryList();
                foreach($countryList as $key=>$val){?>
                    <option value="<?php echo $key;?>" onclick="changeState('<?php echo $key;?>');"><?php echo $val;?></option>
           ...
           <label>State *</label>
            <input name="p_c_state" id="p_c_state"type="text" value="<?php echo set_value('p_c_state');?>">
               <?php echo form_error('p_c_state');?>
           </div>
          ...
          <?php 
           ...
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>choose-plan.png"> &nbsp; Choose Your Plan</h4>
                      <select id = "p_acc_type1"name="p_acc_type1"class="items">
<option value="pm"><?php echo $prem_plan_monthly_name;?></option>
<option value="pa"><?php echo $prem_plan_annual_name;?></option>
</select>
            <div class="full3"><h4><img src="<?php echo USER_SIDE_IMAGES;?>plan-details.png"> &nbsp; Plan Details</h4>
            <ul>
             <?php foreach($service_limits as $key=>$val)
    ...
    <?php if($val['service_premium_status']=='A'){?>
		...
		$("#p_promocode1").keyup(function(){		
			var p_promo_code1 = $("#p_promocode1").val();
                        var p_plan_sub_type1=$("#p_acc_type1_input").val();                                              
    ...
    <footer>
      <div class="footer-in"><div class="links">
           ...
           <?php $footerVideos=_getFooterVideos();?>
            ...
            <li>
              ...
              <div class="dating">
                ...
                <a href="<?php echo $val['fvReadMoreLink'];?>" class="button orange" style="width:85px;" target="_blanck">Read More</a></div>
              <div class="clear"></div>
            </li>
            <?php }?>
          </ul>
        ...
        <div class="footer-bottom">
          ...
          <div class="phone">1-800-363-5791</div>
        </div>
      </div>
    </footer>
  </div>
