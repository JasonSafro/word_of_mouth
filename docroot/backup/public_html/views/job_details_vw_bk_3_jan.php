...
<div id="page-wrap">
    ...
    <div id="main1">
          ...
          <h1><?php echo $companyInfo['catName'].' | '.$companyInfo['buss_name'];?> | Jobs</h1> <div class="breadcrums"> <img src="<?php echo USER_SIDE_IMAGES;?>arrow.png" > <a href="index.html">Home</a> |  <?php echo $companyInfo['catName'].' | '.$companyInfo['buss_name'];?> | Jobs</div></div>
          </div>
          </section>
        </div>
      <div id="section">
        ...
        <article class="section-deals">
            <?php echo $this->load->view('success_error_message_area');?>
             <div class="blank">
              <h1><?php echo $info['buss_name'];?> Jobs</h1>
            </div>
            <div class="deal-box2"> 
...
<!--/*======================== popup start*=====================================/-->
 ...
 <div>
           ...
           <div class="write-review2">                 
               <a onclick="javascript: $('#jAppApplicantResume').click();"><img src="<?php echo USER_SIDE_IMAGES;?>resume.png"/> UPLOAD RESUME</a>
               <input  style="display:none;" name="jAppApplicantResume" id="jAppApplicantResume" type="file"/>
          ...
          <article class="section-right" style="position:relative;">
            ...
            <div class="right-cont">
             <h1>Company Description</h1>
                  <p>The TBC Retail GroupÂ® includes NTBÂ®, Merchant's Tire and Auto CentersÂ®, and Big O TireÂ® stores. Together, there are more than 1200 locations in 41 states, plus Washington DC,  Alberta & British Columbia, Canada. Your store agreements and warranties are accepted at all of them.</p>

<p>Founded at a Farmer's Market in 1972, Tire  Kingdom rapidly outgrew its West Palm Beach location and now operates throughout Florida as well as NC, SC, LA, GA, VT and NH. Tire Kingdom's auto service centers offer quality name-brand tires and comprehensive automotive services.</p>

<p>National Tire & Battery (NTB) was created in  1997 through the merger of two highly regarded tire retailers. NTB's expert service, vast selection, state-of-the-art equipment and exceptional commitment to customers has earned them a reputation for high-quality auto care.</p>

<p>Merchant's Tire & Automotive Centers was  founded in downtown Manassas, VA in 1943 and have since become part of the largest  independent tire and automotive services dealer in the nation. Merchant's offers quality, name-brand tires at locations spanning from  York, PA to Myrtle Beach, SC, encompassing Baltimore and the Northern VA/Metro D.C. area along the way.</p>
</div>
          </article>
          <div class="clear"></div>
        </section>
