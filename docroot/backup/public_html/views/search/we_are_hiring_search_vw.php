          ...
          <article class="section-deals">
           ...
           <div class="zip-search">
               <?php 
                 ...
                 echo form_open_multipart('we_are_hiring/search/', $attr);
                 ?>
            ...
            <div class="deal-box2">
              ...
              <div class="line-one1">
                  ...
                  foreach($categories as $key=>$val){?>
                      <li <?php echo ($cnt%6==0?'class="last"':'');?>><a href="<?php echo base_url()?>we_are_hiring/jobs_by_category/<?php echo $val['catId'];?>"><?php echo substr(trim($val['catName']),0,14);?><img src="<?php echo base_url()."category_images/".$val['catImageName'];?>" alt="images"height="13"width="30"></a></li>
                  <?php $cnt++; }
                  ?>    
                  </ul>
                  <?php }?>
            ...
            <div class="clear"></div>
            <?php $current_functionName=$this->uri->segment(2);?>
            <?php if(($totalRecotds-$showingRecords)>=1){?>
            <div class="see-m"><a href="<?php echo site_url("we_are_hiring/$current_functionName/".$showingRecords + 9);?>" class="button2 orange1">SEE 9 MORE JOBS</a></div>
            <?php }?>
            <?php  }?>  
          </article>
          <div class="clear"></div>
