              ...
              <ul>
                  ...
                  <?php foreach($businessList as $key=>$val){?>
                   <li <?php echo ($cnt%3==0?'class="last"':'');?>>
                       <?php $businessImageUrl =base_url().'LOGO/'.$val['user_id']."/".$val['buss_logo']; ?>
                  <div class="deal-boxes"> <img src="<?php echo $businessImageUrl;?>">
                    <div class="pad-deal">
                      ...
                      <div id="canadaprovinces_<?php echo $key;?>" class="post <?php //echo ($jKey==$numOfJobs-1?"br0":"");?> glidecontent">
                          <?php 
                      $numOfJobs=sizeof($jobList);
                      $count=0;
                      foreach($jobList as $jKey=>$jVal){?> <div class="glidecontent">    
                      <div class="post-left">
...
featuredcontentglider.init({
	gliderid: "canadaprovinces_<?php echo $key;//'1';?>", //ID of main glider container
	contentclass: "glidecontent", //Shared CSS class name of each glider content
	togglerid: "slider_page_links_<?php echo $key;//'1';?>", //ID of toggler container
