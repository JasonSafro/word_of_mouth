...
class Services extends CI_Controller {
        ...
        { 
            ...
            if ($this->session->userdata('user_id') != '')
                ...
                else
                {
                    ...
                    $logoImageName=$data_logo['upload_data']['file_name'];
                }
            ...
            { 
                ...
                $this->__saveBasicFormData($responce['payPalTransactionId']);
                $url = base_url() . 'home';
    ...
    public function submitForm_buss_prem($data)
    {
        ...
        $this->form_validation->set_rules('p_buss_fax', 'Fax', 'xss_clean|trim');
        ...
        if(!empty($tmpCat)){
            if(in_array('other', $this->input->post('p_userCategory')))
                $this->form_validation->set_rules('p_otherCategory', 'Other Category', 'xss_clean|trim|required|max_length[15]|is_unique[tbl_category.catName]');
        }
        ...
        {    
         ...
         if(!empty($_FILES['p_license_docs'])){              
              ...
              /*  $config['allowed_types'] = 'gif|jpg|png|jpeg|GIF|JPG|PNG|JPEG';
               ...
               // $config['quality'] = 100;
                ...
                else
                {
                    ...
                    $bussLogo=$data_logo['p_upload_data']['file_name'];
                }
                //End
