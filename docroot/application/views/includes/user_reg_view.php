    ...
    <div class="sign-mainb">
        ...
        <div class="light-pad">
            <div class="main-light">
                <h1><img src="<?php echo USER_SIDE_IMAGES; ?>shield1.png"  alt="shield" title="shield"> Sign in to access your account</h1>
                <div id="loder2" style="height:100%; width:100%; text-align:center; position:absolute; background-color:#000000; opacity:0.50; left:0;top:0; display: none;">
                    <div style="position:relative; left:0px; top:45%;"><?php echo img(array('src' => USER_SIDE_IMAGES . 'ajax-loader.gif', 'alt' => 'ajax loader', 'title'=> ' loading' )); ?></div>
                </div>
                <?php
                $atr = array("name" => "frm_login", "id" => "frm_login", "method" => "post");
                echo form_open("user/login_user", $atr);
                ?><span id="frm_err"></span>
                <label>Enter your username or email address</label>
                <?php
                if ($this->input->cookie('mem_login_info') != '') {
...
<?php echo form_close(); ?>
    ...
    <div id="light1" class="white_content">
        <div class="sign-mainb">
            ...
            <div class="light-pad">
                <div class="main-light">
                    <h1><img src="<?php echo USER_SIDE_IMAGES; ?>shield2.png"  alt="shield" title="shield"> Register to create an account</h1>
                    ...
                    <?php
                    $atr = array("name" => "frm_register", "id" => "frm_register", "method" => "post");
                    ...
                    <div class="blanks" style="margin-bottom: 10px;">                            
                        <a style="color:white; text-decoration: underline;" title="Terms and Agreement" href="<?php echo site_url('services/terms_and_condition');?>">Terms and Agreement</a>
                    </div>
                    <div class="blanks">
...
<?php } ?>
    ...
    <div id="light_step2" class="white_content" style="top: 1%;">
        <div class="sign-mainb">    
            ...
            <div class="light-pad">
                <div class="main-light">
                    <h1><img src="<?php echo USER_SIDE_IMAGES; ?>shield2.png"  alt="shield" title="shield">Fill this form to complete a registration process.</h1>
                    <?php
                    $atr = array("name" => "frm_register_step2", "id" => "frm_register_step2", "method" => "post");
...
<div id="light_forgot_pwd" class="white_content" style="top: 1%;">
    <div class="sign-mainb">    
        ...
        <div class="light-pad">
            <div class="main-light"> 
                <?php
                $atr = array("name" => "frm_forgot_pwd", "id" => "frm_forgot_pwd", "method" => "post");
...
<div id="light_forgot_uname" class="white_content" style="top: 1%;">
    <div class="sign-mainb">    
        ...
        <div class="light-pad">
            <div class="main-light"> 
<?php
$atr = array("name" => "frm_forgot_uname", "id" => "frm_forgot_uname", "method" => "post");
