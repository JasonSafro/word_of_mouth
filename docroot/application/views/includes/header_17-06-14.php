...
if($pg_name == '')
{
	echo "Search businesses, reviews, download deals and look for jobs all on Word of Mouth Referral | Word of Mouth Referral";
}
else {
	$arr = _getMetadata($pg_name);
	echo $arr['title']." | Word of Mouth Referral";
}
?></title>
...
{
	echo "business advertising, internet business advertising, business reviews, deals, coupons, we're hiring, jobs, employment, quotes, reviews, top deals, internet marketing advertising, daily deals, restaurant coupons, printable coupons";
}
else {
echo $arr['keywords']; 
}?>" />
