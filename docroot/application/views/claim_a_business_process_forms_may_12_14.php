     ...
     <!--------------------------------------step2--------------------------------------------------->
        ...
        ?>
           ...
           <label>Web Address</label>
            <input name="buss_web_addr" id="buss_web_addr"type="text"value="http://<?php echo set_value('buss_web_addr',$tmp_buss_web_address); ?>"/>
...
<!----------------step1------------->
        ...
        ?>
           ...
           <label>Web Address</label>
              <input name="p_buss_web_addr" id="p_buss_web_addr" type="text" value="http://<?php echo set_value('p_buss_web_addr',$tmp_buss_web_address);?>"/>
