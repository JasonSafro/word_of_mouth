...
function saveratings(rating,busId)
    ...
    <div id="page-wrap">
     <div id="main1">
          ...
          <h1>Business Search</h1> <div class="breadcrums"> <img src="<?php echo USER_SIDE_IMAGES;?>arrow.png" > <a href="<?php echo base_url()?>">Home</a> | Provider | Search </div></div>
          </div>
          </section>
        </div>
        <div class="clear"></div>
          ...
          <article class="section-deals">
              ...
              <ul>                 
                ...
                <li <?php echo ($cnt!=0 && $cnt%3==0?'class="last"':'')?>>                     
                  ...
                  <div class="deal-tmain">
                      ...
                      <div class="deal-titlel adt-width">
            ...
            <div class="see-mone"> 
                <?php if($total_count>9 && $remaining_list!=0){
                    ?>                
                <a href="<?php echo base_url()?>home/<?php echo $this->uri->segment(2)?>/<?php echo $current_count+($remaining_list<9?$remaining_list:9);?>" class="button3 orange1">SEE <?php if($remaining_list>=9){?>9 <?php }else{ echo $remaining_list; }?> MORE PROVIDERS</a>       
                <?php }
                else
                {?>
