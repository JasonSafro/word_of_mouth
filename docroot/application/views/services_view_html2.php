...
<title>Word of Mouth Referral | Services, Packages</title>
<meta name="description" content="Word of Mouth Referral | Basic and Premium Packages. Check out our Annual and Monthly rates, cancel at anytime." />
<meta name="keywords" content="Free Search, Reviews, Deals, Jobs, Word of Mouth, Referrals, Small Business, Business, Internet Marketing, Advertising, Local Businesses, coupons, quotes, packages" />
<?php
...
$(document).ready(function() {
  if( typeof responsiveTable !== 'undefined' && $.isFunction(responsiveTable) ) {
...
<script type="text/javascript" charset="utf-8">
			$(document).ready(function(){
        if( typeof wslide !== 'undefined' && $.isFunction(wslide) ) {
...
<?php //echo js_asset("jquery.selectbox-0.5.js");  ?>
  ...
  <script type="text/javascript" charset="utf-8">
        ...
        function initialize(){
            ...
            var selectedState = "<?php echo set_value('userState');?>";                                
            $('#userState').val(selectedState);
           ...
           //When Page Loads- Get State by country(Premium)
            ...
            //set previous selected state
            var selectedState = "<?php echo set_value('p_userState');?>";                                
            $('#p_userState').val(selectedState);
...
<div id="wrapper" >
  ...
  <tr>
    <td><div class="cent"><?php //echo $basic_plan_annual_name;?> Annual & <?php echo $basic_plan_monthly_name;?> price details*<br>
       <span class="ymc">*You may cancel anytime</span></div></td>
    <td>
    <div class="l-p">
    $<?php echo $basic_plan_annual_price;?> <br><h2><?php //echo $basic_plan_annual_name;?>Annual</h2>
    </div>
     <div class="r-p">
   $<?php echo $basic_plan_monthly_price;?> <h2><?php echo $basic_plan_monthly_name;?></h2>  
    ...
    <div class="green-btn">
        ...
        <?php }elseif($this->session->userdata('user_type') == 'site_user'){?>
        ...
        ?>
           ...
           <label>Country * </label>
            <?php 
                ...
                echo form_dropdown('buss_country', _getCountryList(),set_value('buss_country','USA'),$st);
              ?>
           ...
           <label>State *</label>
            <?php 
                $selectedBussCountry=set_value('buss_country','USA');//get selected country value that is country code
                $st='id="buss_state" class="items_custom"';
                echo form_dropdown('buss_state', _getStateList($selectedBussCountry),set_value('buss_state',''),$st);
              ?>
           ...
           <div class="pop-left-second">
     <!--<div class="sip">
<input type="button" class="custome_button red" value="Upload File"><input type="file" class="multi hide" accept="jpg|JPG|jpeg|JPEG|png|PNG|gif|GIF|bmp|BMP" name="aud_pic_file[]" id="aud_pic_file" maxlen="5"/>
 ...
 foreach($service_limits as $key=>$val)
  {
    ...
    <td>
    <div class="l-p">
        $<?php echo $prem_plan_annual_price;?> <br><h2><?php //echo $prem_plan_annual_name;?>Annual</h2>
    </div>
     <div class="r-p">
        ...
        ?>
           ...
           <label>Country * </label>
            <?php 
                ...
                echo form_dropdown('p_buss_country', _getCountryList(),set_value('p_buss_country','USA'),$st);
              ?>
           ...
           <label>State *</label>
            <?php 
                $selectedBussCountry=set_value('p_buss_country','USA');//get selected country value that is country code
                $st='id="p_buss_state" class="items_custom"';
                echo form_dropdown('p_buss_state', _getStateList($selectedBussCountry),set_value('p_buss_state',''),$st);
              ?>
          ...
          <!-- <div style="  width:100%; background: #fff; border: 1px solid #A1A1A1; border-radius:9px; margin:0 0 15px 0;"><select name="p_userCategory" id="p_userCategory"  multiple style="background:none; border:none; width:98%; padding: 0 2%; margin:2% 0">-->
           ...
           <div class="pop-left-second">
               <br/><h4><img src="<?php echo USER_SIDE_IMAGES; ?>media.png"> &nbsp;Upload Vodeo </h4>                
               <div style="float:left; margin-top: 0 auto;"> 
      ...
      <div class="footer-in"><div class="links">
        ...
        <div class="stay">
          ...
          <div class="social1">
            ...
            <span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=YSgYny5Tv9UoC0QPlgP9G6t7qoCZNmmp7d2FnOC462eCGb62rxuW3IRu2hwe"></script></span>
          </div>
        </div>
