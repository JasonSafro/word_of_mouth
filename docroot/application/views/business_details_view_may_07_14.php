            ...
            <div class="ntb-main1">
              ...
              <div class="ntbr">
                <div class="full-des">
                  ...
                  <br><br><br><br>
                <div class="book"><?php  if($info['buss_license_docs']!=""){ ?><img src="<?php echo USER_SIDE_IMAGES;?>down-load.png"> Business License Certification <?php } ?></div>
                ...
                if($info['buss_license_docs']!=""){                
                    ...
                    foreach($businessDocs as $key=>$val){
                        echo '<p id="docsDivId_'.$key.'" style="width:16%;">'.                            
                            anchor('home/download_doc/'.$businessId.'/'.$val,img(array('src'=>base_url().'sitedata/images/download-ico.jpg')),array('target'=>"_blanck",'title'=>'Download business document')).
                            ' Doc'.++$c.' '.'</p>';
                    }
                }        
                ?>
