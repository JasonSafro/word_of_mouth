  ...
  <tr>
   ...
   $<?php echo $basic_plan_monthly_price;?> <h2><?php echo $basic_plan_monthly_name;?></h2>  
    ...
    <!--/*======================== popup start1=====================================/-->
        ...
        echo form_open('claim/registeration/basic/1/'.$claimRequestId.'#address10', $attributes);
        ?>
     ...
     <!--------------------------------------step2--------------------------------------------------->
        ...
        echo form_open_multipart('claim/registeration/basic/2/'.$claimRequestId.'#address11', $attributes);        
        //echo form_open_multipart('claim/registeration/basic/2/'.$claimRequestId, $attributes);        
        ?>
           <div class="pop-left ">
           <div class="pop-left-first">
...
<?php foreach($service_limits as $key=>$val)
  {?>
   ...
   $<?php echo $prem_plan_monthly_price;?> <h2><?php echo $prem_plan_monthly_name;?></h2>  
    ...
    <div class="clear"></div>
    <div class="green-btn">
        <?php if($claimRequestedUserId=='' || $claimRequestedUserId==0){ ?>
...
<!----------------step1------------->
        ...
        //echo form_open('services/submitForm_basic', $attributes);
         echo form_open('claim/registeration/prem/1/'.$claimRequestId.'#address12', $attributes);
        ...
        echo form_open_multipart('claim/registeration/prem/2/'.$claimRequestId.'#address13', $attributes);
        ?>
           <div class="pop-left">
           <div class="pop-left-first">
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>create.png"> &nbsp; Business Name</h4>
           ...
           <label>Web Address</label>
              <input name="p_buss_web_addr" id="p_buss_web_addr" type="text" value="<?php if($tmp_buss_web_address){echo set_value('p_buss_web_addr',$tmp_buss_web_address);} ?>"/>
