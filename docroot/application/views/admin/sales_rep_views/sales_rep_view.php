...
<div id="content"> 
  ...
  <div id="right"> 
    ...
    <div class="box"> 
     <!-- box / title -->
      <div class="title">
        <h5>Manage Registered Sales Representative</h5>
        <!--<div class="search">
      ...
      <!-- end box / title -->
            ...
            $form_url = ADMIN_FOLDER_NAME.'/manage_sales_rep/soft_delete_selected/'.$sort_by.'/'.$sort_type.'/'.($offset - 1);

            echo form_open($form_url, $attr);
            ?>
           <div class="table">
               <p><?php echo $total_sal_rep_count;?> registered Sales Representative - TOTAL</p>
                    ...
                    <?php $newOffset= ($offset -1);?>
                        <thead>
                            ...
                            <tr>
                                ...
                                <th width="9%" align="left" class="<?php echo ($sort_by=="adm_contactno" ? ($sort_type=="ASC" ? "rowASC" : "rowDESC") : "");?>">
                                    <?php                                
                        ...
                        <?php foreach($sal_rep_List as $key=>$val){?>
                        <tbody>
                               <tr>
                                   ...
                                   <!-- <td><?php if($val['adm_updated_date']=='0000-00-00 00:00:00')echo "--";else echo $val['adm_updated_date'];?></td>-->
                                    ...
                                    <td>                                        
                                        <?php 
                                        $status_url=ADMIN_FOLDER_NAME.'/manage_sales_rep/change_status/' .$sort_by.'/'.$sort_type.'/'.$newOffset;
                                        if($val['adm_status']=='A'){
                                        ...
                                        <?php $edit_url=ADMIN_FOLDER_NAME.'/manage_sales_rep/edit/' .$val['adm_id'].'/'.$sort_by.'/'.$sort_type.'/'.$newOffset;?>
                                        <?php echo anchor($edit_url, img(array('src' => 'assets/images/edit.png', 'border' => '0', 'width' => '16', 'height' => '16', 'alt' => 'Edit record'))); ?> &nbsp;					
                                        <?php $delete_url=ADMIN_FOLDER_NAME.'/manage_sales_rep/delete/' .$val['adm_id'].'/'.$sort_by.'/'.$sort_type.'/'.$newOffset;?>
