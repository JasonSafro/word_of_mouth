...
<!--select-->
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js" type="text/javascript" charset="utf-8"></script>
     ...
     <script type="text/javascript" charset="utf-8">
        ...
        function print_country(country_id){
            ...
            $.ajax({
                    type: "GET",                                        
                    url: '<?php echo base_url() ?>services2/getCountrys',
                    dataType:"json",
        ...
        function print_state(state_id, countryCode){         
         ...
         $.ajax({
                    type: "GET",                                        
                    url: '<?php echo base_url() ?>services2/getStateList/'+countryCode,
                    dataType:"json",
                    success: function (data) {
	...
	$(document).ready(function() {
                 //print_country('userCountry2');
                 //alert('heelo');
                 $('.items').selectbox();
		
                    $('#userCountry2_input').blur(function(){
                       setTimeout(function(){
                        var e = document.getElementById("userCountry2");
  ...
  <tr>
   ...
   $<?php echo $basic_plan_monthly_price;?> <h2><?php echo $basic_plan_monthly_name;?></h2>  
    ...
    <!--/*======================== popup start1=====================================/-->
        ...
        ?>
          ...
          <input name="city" id="city"type="text" value="">
           ...
           <?php 
                        ...
                        ?>   
            <select name="Items" id="userCountry2" class="items" onchange="changeSyate('userState',this.selectedIndex);">
                <?php 
           ...
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>choose-plan.png"> &nbsp; Choose Your Plan</h4>
            <select name="select_plan" class="items">
      ...
      <input  style="display:none;" id="submitbtn12" value="PROCEED TO STEP 2"  type="submit"/>
            <br><br>
