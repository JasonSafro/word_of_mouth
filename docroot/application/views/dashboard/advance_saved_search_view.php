                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           ...
                           <input name="minRating" id="minRating" type="hidden" value="<?php echo $val['minRating'];?>"  class="chkmsg"/>
                            <tr>
                                ...
                                <?php  echo anchor($delete_url, img(array('src' => USER_SIDE_IMAGES.'cross.png', 'border' => '0', 'width' => '16', 'height' => '16', 'alt' => 'Delete record','class'=>'imgMiddleAlign')), array("onclick" => "javascript: return confirm('Do you want to delete this?');")); ?>
                                </td>
