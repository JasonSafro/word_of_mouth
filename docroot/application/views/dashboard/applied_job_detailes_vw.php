    ...
    <div id="section">
        <div class="b-strip">
            <section id="main">
                ...
                <div class="links">
                    <a href="<?php echo base_url() ?>">Home</a> | <a href="<?php echo base_url() ?>dashboard/account_overview">Dashboard</a> | <?php echo anchor('dashboard/applied_jobs','Applied Jobs');?> | Application details
                </div>
            </section></div>
                ...
                <div class="dash-r">    
                    ...
                    <div class="dash-form">
                        <table width="100%">
                            ...
                            <tr><td class="t-top1">Resume</td><td class="t-top1"><?php echo ($info['jAppApplicantResume']==""?"No resume attached":anchor('dashboard/applied_jobs/download_resume/'.$info['jAppId'].'/'.$info['jAppApplicantResume'],'Download resume'));?></td></tr>
                            <tr><td class="t-top1">Cover letter</td><td class="t-top1"><?php echo ($info['jAppApplicantCoverLetter']==""?"No coverletter attached":anchor('dashboard/applied_jobs/download_coverlatter/'.$info['jAppId'].'/'.$info['jAppApplicantCoverLetter'],'Download cover letter'));?></td></tr>
                            <tr><td class="t-top1">Applied date</td><td class="t-top1"><?php echo $info['jAppCreatedOn'];?></td></tr>
                            <tr><td class="t-top1">Application Status</td><td class="t-top1"><?php echo $info['jAppStaus'];?></td></tr>
                            
                        </table>
                    </div>
                </div>
                
                <a class="button7" href="#" onclick="history.back(-1)" style="margin-top: 5px;">Back</a>
