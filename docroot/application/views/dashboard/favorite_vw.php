                    ...
                    <div class="main-t">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <th class="t-top3" width="10%">Action</th>
                            </tr>
                            <?php
                            if (count($fav_Info) != 0) {//bussStatus
                                foreach ($fav_Info as $key => $val) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="t-top3" align="center">
                                        <?php echo anchor(site_url('dashboard/favorite/delete/' . $val['buss_favorite_id']), img(array('src' => USER_SIDE_IMAGES . 'cross.png', 'border' => '0', 'width' => '16', 'height' => '16', 'alt' => 'Delete record','class'=>'imgMiddleAlign')), array("onclick" => "if(!confirm('Do you want to delete this?')) return false;")); ?>
                                        </td>
                                    </tr>
