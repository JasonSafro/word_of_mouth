                           ...
                           <?php foreach($jobList as $key=>$val){?> 
                            <tr>
                                ...
                                <td class="t-top1" align="center">
                                   ...
                                   <a href="<?php echo site_url('dashboard/jobs/delete_job/'.$val['jobId']);?>" onclick="javascript: return confirm('Do you wants to delete this job?');" title="Delete job"><img class="imgMiddleAlign" src="<?php echo USER_SIDE_IMAGES.'delete.png'?>"></a>
                                </td>
