...
<?php //echo js_asset("jquery.selectbox-0.5.js");  ?>
  ...
  <script type="text/javascript" charset="utf-8">
	...
	$(document).ready(function() {
		//$('.items').selectbox();
		 ...
		 //When Country Changes, Change State 
                ...
                $("#p_acc_type").change(function() {$('#p_promocode').val("");$("#p_pro_code_err").html("");
                    setTimeout(function(){
    ...
    $("#userCountry").selectbox({
     ...
     <script type="text/javascript" charset="utf-8">
         //now not in use. (was used when we are using select box js)
    ...
    <!--/*======================== popup start1=====================================/-->
        ...
        ?>
          ...
          <?php echo form_error('city');?>
           ...
           <div id="stateHolder">
            <?php 
                           // $st='id="userState" class="items_custom"';//stateHolder
     ...
     <!--------------------------------------step2--------------------------------------------------->
        ...
        ?>
           ...
           <input name="buss_name" id="buss_name"type="text" value="<?php echo set_value('buss_name'); ?>" maxlength="32"/>
           ...
           <label>Business Category *  (2 Max)</label>
            <!--<select name="Items" class="items_custom">
            <option>Automotive</option>
            </select>-->
            <?php 
           //$xm='id="userCategory" class="items_custom"';
           ...
           <br>
            ...
            <div class="pop-left-first-two">
                <input name="buss_sco_one" id="buss_sco_one" type="text" value="<?php echo set_value('buss_sco_one'); ?>"/>
                <?php echo form_error('buss_sco_one'); ?>
            </div>
            <div class="clear"></div>
             <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h2.png"></div>
            <div class="pop-left-first-two">
                <input name="buss_sco_two" id="buss_sco_two" type="text" value="<?php echo set_value('buss_sco_two'); ?>"/>
           ...
           <label>&nbsp;</label><br>
            ...
            <div class="pop-left-first-two">
                <input name="buss_sco_three" id="buss_sco_three" type="text" value="<?php echo set_value('buss_sco_three'); ?>"/>
                <?php echo form_error('buss_sco_three'); ?>
            </div>
             <div class="clear"></div>
              <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h4.png"></div>
            <div class="pop-left-first-two">
                <input name="buss_sco_four" id="buss_sco_four" type="text" value="<?php echo set_value('buss_sco_four'); ?>"/>
     ...
     <!--------------------------------------credit card------------------------------------------------- -->             
          ...
          <label>Email </label>
           ...
           ?>
            <!--<select name="c_Items" id="c_userCountry" class="items_custom">
                <?php 
                $countryList= _getCountryList();
                foreach($countryList as $key=>$val){?>
     ...
     <input type="hidden" name="basicHiddenPaymentType" id="basicHiddenPaymentType" value="<?php echo set_value('basicHiddenPaymentType','visaImg');?>"/>
      <script>
           ...
           <div class="pop-right rel-position pad-bottom"><h4><h4><img src="<?php echo USER_SIDE_IMAGES;?>choose-plan.png"> &nbsp; Choose Your Plan</h4>
            <select id = "b_acc_type"name="b_acc_type" class="items_custom">
...
<!----------------step1----------- -->
        ...
        ?>
           ...
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>create.png"> &nbsp; Business Name</h4>
           <label>Name *<span>(alphanumeric, no more than 32 characters)</span></label>
            <input name="p_buss_name" id="p_buss_name"type="text" value="<?php echo set_value('p_buss_name'); ?>" maxlength="32"/>
           ...
           <label>Business Category *</label>
            <!--<select name="" class="items_custom">
          ...
          <!-- <div style="  width:100%; background: #fff; border: 1px solid #A1A1A1; border-radius:9px; margin:0 0 15px 0;"><select name="p_userCategory" id="p_userCategory"  multiple style="background:none; border:none; width:98%; padding: 0 2%; margin:2% 0">-->
            <?php 
           //$xm='id="p_userCategory" class="items_custom"';
           ...
           <div style=" float:left; width:100%; background: #fff; border: 1px solid #A1A1A1; border-radius:9px; margin:0 0 15px 0;">
            ...
            <!--<select name="p_userCategory" id="p_userCategory" class="items_custom"> -->
                <?php 
                $categoryList= _getCategoryList();
                foreach($categoryList as $key=>$val){?>
          ...
          <label> <input name="comp_quot" type="checkbox" value="1" <?php echo set_checkbox('comp_quot', '1'); ?>/> &nbsp;Click to receive competitive quotes</label>
           ...
           <br>
             <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h1.png"></div>
            <div class="pop-left-first-two">
                <input name="p_buss_sco_one" id="p_buss_sco_one" type="text" value="<?php echo set_value('p_buss_sco_one'); ?>"/>
                <?php echo form_error('p_buss_sco_one'); ?>
            </div>
            <div class="clear"></div>
             <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h2.png"></div>
            <div class="pop-left-first-two">
                <input name="p_buss_sco_two" id="p_buss_sco_two" type="text" value="<?php echo set_value('p_buss_sco_two'); ?>"/>
           ...
           <label>&nbsp;</label><br>
            <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h3.png"></div>
            <div class="pop-left-first-two">
                <input name="p_buss_sco_three" id="p_buss_sco_three" type="text" value="<?php echo set_value('p_buss_sco_three'); ?>"/>
                <?php echo form_error('p_buss_sco_three'); ?>
            </div>
             <div class="clear"></div>
              <div class="pop-left-first-one"><img src="<?php echo USER_SIDE_IMAGES;?>h4.png"></div>
            <div class="pop-left-first-two">
                <input name="p_buss_sco_four" id="p_buss_sco_four" type="text" value="<?php echo set_value('p_buss_sco_four'); ?>"/>
     ...
     <!--------------------------------------credit card------------------------------------------------- -->             
          ...
          <?php 
           ...
           <h4><img src="<?php echo USER_SIDE_IMAGES;?>choose-plan.png"> &nbsp; Choose Your Plan</h4>
                      <select id = "p_acc_type1"name="p_acc_type1" class="items_custom">
