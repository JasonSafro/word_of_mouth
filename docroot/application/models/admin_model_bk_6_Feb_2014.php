...
class admin_model extends CI_Model {
    ...
    function getJobList($where='',$sortBy=NULL,$sortType=NULL,$limit=NULL,$offset=NULL)
    {
        ...
        $sql="SELECT j.*,b.buss_name,t.jobType FROM tbl_jobs as j 
    ...
    function get_business_list($sortBy=NULL,$sortType=NULL,$limit=NULL,$offset=NULL,$where='')
    {
        ...
        if($limit!=NULL && $offset!=NULL)
         ...
         $where.=$limitstring;
        //echo $where;
        $sql="select  b.*,CONCAT(u.user_fname,' ',u.user_lname) as userFullName,c.catName
              from tbl_business_info as b
              LEFT JOIN tbl_user as u ON b.user_id=u.user_id 
              LEFT JOIN tbl_category as c ON c.catId=b.buss_category ".$where;
    ...
    function getDealList($where='',$sortBy=NULL,$sortType=NULL,$limit=NULL,$offset=NULL)
    {
        ...
        $sql="SELECT d.*,b.buss_name,b.buss_address,b.buss_addr_addon,b.buss_city,b.buss_zip_code,b.buss_phone,b.buss_category,c.catName
             FROM tbl_deals as d 
	...
	function get_user_business_list($sortBy=NULL,$sortType=NULL,$limit=NULL,$offset=NULL,$where)
	{
        ...
        $sql="select  b.*,CONCAT(u.user_fname,' ',u.user_lname) as userFullName from tbl_business_info as b
		      LEFT JOIN tbl_user as u ON b.user_id=u.user_id ".$where;
        return $this->db->query($sql)->result_array();
