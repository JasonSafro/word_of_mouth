...
class website_general_model extends CI_Model {
    ...
    function getJobList($where='',$sortBy=NULL,$sortType=NULL,$limit=NULL,$offset=NULL)
    {
        ...
        $sql="SELECT j.*,b.buss_name,b.buss_logo,t.jobType,c.catName,c.catImageName,c.catId
            FROM tbl_jobs as j 
    ...
    function getBusinessInfoList($where,$sortBy=NULL,$sortType=NULL,$limit=NULL,$offset=NULL)
    {
        ...
        $where.=$limitstring; //tbl_business_info
         ...
         $sql="SELECT b.*,c.catName,c.catImageName 
	...
	function getDealViewList($where='',$sortBy=NULL,$sortType=NULL,$limit=NULL,$offset=NULL,$groupby='')
    {
        ...
        $where.=$orderString;
     	 ...
     	 $sql="SELECT distinct(v.bvwDealId),d.*,b.buss_name,b.buss_id,b.buss_avg_ratings,b.buss_address,b.buss_addr_addon,b.buss_city,b.buss_zip_code,b.buss_phone,b.buss_category,c.catName
